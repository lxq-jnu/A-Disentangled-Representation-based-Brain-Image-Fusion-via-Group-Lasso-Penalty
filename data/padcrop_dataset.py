...
class PadCropDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.opt = opt
        #self.dir_A = os.path.join(opt.dataroot,'A',opt.phase)  # get the image directory
        #self.dir_B = os.path.join(opt.dataroot,'B',opt.phase)
        self.dir_A = os.path.join(opt.dataroot,'A')  # get the image directory
    ...
    def __getitem__(self, index):
        ...
        return {'A': A, 'B': B, 'A_paths': A_path, 'B_paths': B_path,'w':w,'h':h}
