...
class TestDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        #self.dir_A = os.path.join(opt.dataroot, 'ir')
        #self.dir_B = os.path.join(opt.dataroot, 'vis')

        #self.dir_A = os.path.join(opt.dataroot, 'A')
        #self.dir_B = os.path.join(opt.dataroot, 'B')

        #self.dir_A = os.path.join(opt.dataroot, 'duo1')
        #self.dir_B = os.path.join(opt.dataroot, 'duo2')

        self.dir_A = os.path.join(opt.dataroot, 'MRI')
        self.dir_B = os.path.join(opt.dataroot, 'SPECT_Y')
    ...
    def __getitem__(self, index):
        ...
        return {'A': IR, 'B': VIS, 'A_paths': A_path, 'B_paths': A_path}
