...
for i in range(0, 10):
    ...
    path1 = os.path.join("./test_imgs_mripet/",'MRI'+ str(i + 1) + ".png")
    path2 = os.path.join("./test_imgs_mripet/", 'PET'+str(i + 1) + ".png")
    ...
    image_path = os.path.join("./results_mripet/", str(i+1) + ".png")
    fold_path = os.path.join("./results_mripet/")
