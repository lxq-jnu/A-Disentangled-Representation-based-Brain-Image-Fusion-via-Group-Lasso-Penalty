...
for i in range(0, 10):
    ...
    path1 = os.path.join("./test_imgs_mrict/",'MRI'+ str(i + 1) + ".png")
    path2 = os.path.join("./test_imgs_mrict/", 'CT'+str(i + 1) + ".png")
    ...
    image_path = os.path.join("./results_mrict/", str(i+1) + ".png")
    fold_path = os.path.join("./results_mrict/")
